import type { DreameActionDefinition, DreamePropertyDefinition, DreameProtocolModule } from '../types/dreame';

const DreameWaterVolumes: Record<string, number> = {
    UNKNOWN: -1,
    LOW: 1,
    MEDIUM: 2,
    HIGH: 3,
...
const DreameErrors: Record<string, number> = {
    UNKNOWN: -1,
    NO_ERROR: 0,
    DROP: 1,
    CLIFF: 2,
...
const DreameState: Record<string, number> = {
    UNKNOWN: -1,
    SWEEPING: 1,
    IDLE: 2,
    PAUSED: 3,
...
const DreameWashBaseState: Record<string, number> = {
    IDLE: 0,
    WASHING: 1,
    DRYING: 2,
    RETURNING: 3,
...
const DreameProperties: Record<string, DreamePropertyDefinition> = {
    STATE: {
        did: '',
        siid: 2,
        piid: 1,
...
const DreameActions: Record<string, DreameActionDefinition> = {
...
const DreameBlockedObjects: string[] = [
    'carpet_mode',
    'clean_home',
    'clearQueue',
    'fan_power',
...
export const dreameProtocol: DreameProtocolModule = {
    DreameWaterVolumes,
    DreameErrors,
    DreameState,
    DreameWashBaseState,

...
systemDictionary = {
    "title": {
        "en": "adapter for control of Xiaomi vacuum cleaner V1 and S5",
        "de": "Adapter zur Steuerung von Xiaomi Staubsauger V1 und S5",
        "ru": "адаптер для управления пылесосом V1 и S5 Xiaomi",
        "pt": "Adaptador para controle da aspiradora Xiaomi V1 e S5",
        "nl": "adapter voor aansturing van Xiaomi-stofzuiger V1 en S5",
        "fr": "adaptateur pour le contrôle de l'aspirateur Xiaomi V1 et S5",
        "it": "adattatore per il controllo dell'aspirapolvere Xiaomi V1 e S5",
    ...
    "Request Intervall": {
        ...
        "ru": "Запросить интервал в мс",
        "pt": "Solicitar Intervall em ms",
        "nl": "Interval aanvragen in ms",
        "fr": "Demander Intervall en ms",
        "it": "Richiesta Intervall in ms",
    ...
    "add a state for Alexa": {
        ...
        "de": "Füge einen Status für Alexa hinzu",

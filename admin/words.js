...
systemDictionary = {
    ...
    "adapter for control of Xiaomi vacuum cleaner V1 and S5": {
        "en": "adapter for control of Xiaomi vacuum cleaner",
        "de": "Adapter zur Steuerung von Xiaomi Staubsauger",
        "ru": "адаптер для управления пылесосом Xiaomi",
        "pt": "Adaptador para controle da aspiradora Xiaomi",
        "nl": "adapter voor aansturing van Xiaomi-stofzuiger ",
        "fr": "adaptateur pour le contrôle de l'aspirateur Xiaomi ",
        "it": "adattatore per il controllo dell'aspirapolvere Xiaomi ",
        "es": "adaptador para el control de la aspiradora Xiaomi",
        "pl": "adapter do sterowania odkurzacza Xiaomi ",
        "zh-cn": "用于控制小米吸尘器V1和S5的适配器"
    },

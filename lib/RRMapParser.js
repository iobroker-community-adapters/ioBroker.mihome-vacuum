...
RRMapParser.PARSE_BLOCK = function parseBlock(buf, offset, result) {
    ...
    switch (type) {
        ...
        case RRMapParser.TYPES.IMAGE:
            ...
            parameters.position.top = DIMENSION_PIXELS - parameters.position.top - parameters.dimensions.height;

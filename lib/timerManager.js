        ...
        adapter.getStatesOf("timer", function (err, timerObjects) {
            try {
                ...
                adapter.getStates('timer.*', function (err, timerStates) {
                    ...
                    let nextTimerName = timerManager.nextTimerId ? i18n.weekDaysFull[timerManager.nextProcessTime.getDay()] + ' ' + adapter.formatDate(timerManager.nextProcessTime, "hh:mm") : i18n.notAvailable
                    let timerFolder = {

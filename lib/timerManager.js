        ...
        if (this.nextProcessTime > 0 && this.nextProcessTime < new Date()) {
            ...
            if (diff > 3600000) {
                ...
                setTimeout(function () {
                    ...
                    adapter.setForeignState(timerManager.nextTimerId, TimerManager.START, false, function (err, obj) {
            ...
            try {
                ...
                adapter.getStates('timer.*', function (err, timerStates) {
                    ...
                    for (let t in timerStates) {
                        if (timerStates[t].val != TimerManager.DISABLED) {
                    ...
                    let timerFolder = {
                        ...
                        common: { name: i18n.nextTimer + ': ' + (timerManager.nextTimerId ? i18n.weekDaysFull[timerManager.nextProcessTime.getDay()] + ' ' + adapter.formatDate(timerManager.nextProcessTime, "hh:mm") : i18n.notAvailable) }
                    }

...
export interface RoomAdapter {
    ...
    setStateChanged(id: string, value: unknown, acknowledge: boolean, callback?: (error: unknown, id?: string, notChanged?: boolean) => void): void;
    ...
    getForeignStates(ids: string[], callback: (error: unknown, states?: Record<string, RoomState | null>) => void): void;
    ...
    getObjectAsync(id: string): Promise<{
        common: Record<string, unknown>;
    } | null | undefined>;
    getForeignObjects(pattern: string, type: string, enumName: string, callback: (error: unknown, objects?: Record<string, RoomObject>) => void): void;
